...
const Profile = () => {
    ...
    axiosSecure
      ...
      .then((res) => {
        if (res.data.modifiedCount) {
          Swal.fire("Success!", "Profile updated successfully. Please Reload", "success");
          refetch();
  ...
  return (
    <div className="space-y-12 p-2 md:p-6">
      ...
      {/* modal - modal-bottom বাদ দেওয়া হয়েছে যাতে সব স্ক্রিনে মাঝখানে থাকে */}
      <dialog id="update_modal" className="modal">
        <div className="modal-box w-full max-w-xl">
          <h3 className="font-bold text-xl mb-4">Update Profile</h3>

          {/* handleSubmit দিয়ে ফর্ম র্যাপ করা হলো, যার ফলে পেজ রিলোড লকড */}
